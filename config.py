...
# CEA input
fuel            = 'CH4'               # choose existing fuel or oxidiser from rocketcea or create new fuel or oxidiser blend in PropLibrary
ox              = 'LOX'
...
MR              = 3.0
m_dot           = 1.2                                # total mass flow [kg/s]
m_dot_f         = m_dot / (MR + 1)
m_dot_ox        = m_dot - m_dot_f
Pc              = 20e5                               # Chamber pressure [Pa]

# Coolant input
cooling_fluid   = ['CH4']                            # needs to be list of str
...
inlet_temp      = 100.0                     		 # inlet temperature [K]
inlet_pressure  = 40e5                               # Cooling channel inlet pressure [Pa]
...
# Film cooling settings for coolant eminaing from the injector face
m_dot_film = 0.0 * m_dot_f
injection_velocity = 10								  # [m/s]
injector_diameter  = 0.4e-3							  # [m]

# Chamber geometry
D_c       = 120e-3                                   # chamber diamter [m]
D_t       = 40e-3                                    # throat diameter [m]
D_e       = 90e-3                                    # exit diamter [m]
