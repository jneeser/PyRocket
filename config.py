...
# CEA input
fuel            =  proplib.mehtanol80                # choose existing fuel or oxidiser from rocketcea or create new fuel or oxidiser blend in PropLibrary
ox              = 'N2O'
...
fluid_mass_frac = [0.8, 0.2]    			         # mass fractions of the cooling fluid (needs to add up to 1)
